-- ============================================================
-- RPC: process_checkout (UPDATED FOR OUTLET MULTI-TENANCY)
-- Atomic POS checkout — stock validation, transaction creation,
-- inventory decrement, and double-entry journal in ONE call.
-- ============================================================
-- NOTE: This function runs as SECURITY DEFINER to bypass RLS.
-- ============================================================
...
BEGIN
    ...
    -- ========================================================
    -- (No triggers to disable anymore since we removed them for products)
